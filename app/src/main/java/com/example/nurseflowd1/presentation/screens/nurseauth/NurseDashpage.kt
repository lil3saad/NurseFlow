...
import com.example.nurseflowd1.presentation.screens.paitentdash.medication.EpochDateDisplay
    ...
    Column(modifier = modifier.fillMaxSize().background(AppBg),
        ...
        LazyColumn(modifier = Modifier.padding(top = ScreenWidth(0.05).dp )
            ...
            when(val state = roompatientliststate){
                ...
                is RoomPatientListState.Error -> {  item { Text("${state.msg}") } }
            }
        }
    }
}
                ...
                FloatingActionButton(
                    ...
                    modifier = Modifier.size( 70.dp )
                        .constrainAs(dcricle) {
                            ...
                            navController.navigate(Destinations.AddNoteScreen.createRoute(false , 0 , noteTitle = "" , noteBody = "") )
                        },
                    containerColor = AppBg,
                ) {}
                FloatingActionButton(
